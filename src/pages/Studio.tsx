...
import {
  BarChart2, Video, MessageCircle, DollarSign,
      ...
      <div className="flex">
        ...
        <div className="w-48 bg-gray-900 min-h-screen border-r border-gray-800 pt-4">
          ...
          <div className="mt-4 border-t border-gray-800 pt-4">
            <Link
              to="/upload"
              className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-400 hover:bg-gray-800 hover:text-white transition"
            >
        ...
        <div className="flex-1 p-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="bg-gray-900 rounded-xl p-4">
                  ...
                  <p className="text-gray-400 text-xs">Total Videos</p>
          ...
          {activeTab === 'content' && (
            <div>
              ...
              {videos.length === 0 ? (
                <p className="text-gray-400 text-center py-12">No videos yet!</p>
              ) : (
                          ...
                          <td className="p-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="p-1.5 rounded bg-blue-500/20 text-blue-400 hover:bg-blue-500/40 transition"
                              >
                                <Edit className="w-4 h-4" />
                              </button>
                              <button
                                onClick={() => handleDelete(video.id)}
                                className="p-1.5 rounded bg-red-500/20 text-red-400 hover:bg-red-500/40 transition"
                              >
          ...
          {activeTab === 'comments' && (
            <div>
              ...
              {comments.length === 0 ? (
                <p className="text-gray-400 text-center py-12">No comments yet!</p>
              ) : (
                  ...
                  {comments.map((comment) => (
                    <div key={comment.id} className="bg-gray-900 rounded-xl p-4 flex items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded bg-red-500/20 text-red-400 hover:bg-red-500/40 transition shrink-0"
                      >
                        <Trash2 className="w-4 h-4" />
                      </button>
                    </div>
          ...
          <div className="bg-gray-900 rounded-xl p-6 w-full max-w-md">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full bg-gray-800 text-white rounded-lg px-4 py-2 outline-none focus:ring-2 focus:ring-red-500"
              />
            </div>
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={3}
                className="w-full bg-gray-800 text-white rounded-lg px-4 py-2 outline-none focus:ring-2 focus:ring-red-500 resize-none"
              />
            </div>
            <div className="flex gap-3">
              <button
